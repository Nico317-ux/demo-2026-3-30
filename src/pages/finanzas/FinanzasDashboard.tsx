  ...
  return (
    <div ref={container} className="w-full flex flex-col gap-8">
      ...
      <div className="page-header flex justify-between items-end">
        <div>
          <h2 className="text-2xl font-extrabold font-headline tracking-tight text-on-surface">Inteligencia Financiera</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* KPI Cards */}
        <div className="bento-item glass-card p-6 group relative overflow-hidden border-t-2 border-[var(--color-tertiary)] hover:border-[var(--color-tertiary)] hover:shadow-[0_0_30px_rgba(155,255,206,0.1)] transition-all">
          ...
          <p className="text-2xl font-display font-extrabold text-white font-headline tracking-tighter">{fmt(mockKpis.valorInventarioPareto_USD)}</p>
        ...
        <div className="bento-item glass-card p-6 group relative overflow-hidden border-t-2 border-[var(--color-primary)] hover:border-[var(--color-primary)] hover:shadow-[0_0_30px_rgba(144,171,255,0.1)] transition-all">
          ...
          <p className="text-2xl font-display font-extrabold text-white font-headline tracking-tighter">{fmt(mockKpis.valorInventarioFueraPareto_USD)}</p>
        ...
        <div className="bento-item glass-card p-6 group relative overflow-hidden border-t-2 border-[var(--color-secondary)] hover:border-[var(--color-secondary)] hover:shadow-[0_0_30px_rgba(255,113,101,0.1)] transition-all">
           ...
           <p className="text-2xl font-display font-extrabold text-white font-headline tracking-tighter">24.5%</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bento-item lg:col-span-2 glass-card p-8 flex flex-col justify-between border-l-[6px] border-l-[var(--color-primary)]">
          ...
          <div className="flex flex-col md:flex-row gap-8 flex-1 items-stretch">
            <div className="flex-1 flex flex-col justify-center">
              ...
              <h4 className="text-xl font-extrabold text-white mt-5 leading-snug font-headline">{topSku.descripcion}</h4>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-[var(--color-surface-container)]/80 p-5 rounded-2xl border border-[rgba(65,71,91,0.2)]">
                  ...
                  <p className="text-lg font-headline font-extrabold text-[var(--color-tertiary)]">{fmt(topSku.ventas_usd)}</p>
                </div>
                <div className="bg-[var(--color-surface-container)]/80 p-5 rounded-2xl border border-[rgba(65,71,91,0.2)]">
                  <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-[0.2em] mb-1.5">Margen Generado</p>
                  <p className="text-lg font-headline font-extrabold text-[var(--color-primary)]">24.5%</p>
                </div>
              </div>
            ...
            <div className="w-full md:w-64 bg-[var(--color-surface-container)] rounded-3xl border border-[var(--color-primary)]/10 flex items-center justify-center relative overflow-hidden group hover:border-[var(--color-primary)]/40 hover:shadow-[0_0_30px_rgba(144,171,255,0.1)] transition-all">
              ...
              <div className="text-center z-10 relative flex flex-col items-center">
                ...
                <p className="text-xl font-headline font-bold text-white mt-1">Alta</p>
        ...
        <div className="bento-item space-y-6">
          <div className="glass-card p-5 border-l-[4px] border-[var(--color-secondary)] group overflow-hidden relative transition-all hover:shadow-[0_0_20px_rgba(255,113,101,0.15)]">
          ...
          <div className="glass-card p-5 border-l-[4px] border-[var(--color-tertiary)] group overflow-hidden relative transition-all hover:shadow-[0_0_20px_rgba(155,255,206,0.15)]">
          ...
          <div className="glass-card p-6 border border-[rgba(65,71,91,0.2)]">
